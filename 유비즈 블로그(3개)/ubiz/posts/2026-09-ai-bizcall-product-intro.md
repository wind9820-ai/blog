...
![썸네일 - 사무실 전화를 스마트폰으로 U+ AI 비즈콜](assets/ai-bizcall/00_thumbnail.png)
...
![사무실 전화로 업무를 처리하는 연출 이미지](assets/ai-bizcall/01_office_phone_smartphone.png)
...
![노트북 옆에서 스마트폰을 사용하는 연출 이미지](assets/ai-bizcall/02_company_number_call.png)
...
![책상 위 노트북과 스마트폰 연출 이미지](assets/ai-bizcall/03_dnd_mode.png)
...
고객과 전화가 많은 영업팀이나 상담업무가 많은 조직이라면 통화내용을 정리하고 후속 업무를 챙기는 과정에서 활용할 수 있는 기능입니다.

![스마트폰 옆에서 업무 내용을 정리하는 연출 이미지](assets/ai-bizcall/04_ai_support.png)
...
![노트북과 스마트폰으로 업무를 관리하는 연출 이미지](assets/ai-bizcall/05_company_managed_number.png)
...
![업무 환경을 함께 확인하는 상담 연출 이미지](assets/ai-bizcall/06_contact.png)
...
*사진은 서비스 이해를 돕기 위한 연출 이미지이며 실제 고객 현장, AI 비즈콜 앱 화면 또는 제공 단말 모델을 나타내지 않습니다.*
