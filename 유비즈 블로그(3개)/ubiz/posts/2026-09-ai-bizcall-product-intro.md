...
1. **도입 이미지** — 사무실 유선전화와 스마트폰을 함께 보여주는 실제 업무환경 사진  
   캡션: “사무실 전화와 스마트폰을 연결하는 U+ AI 비즈콜”

2. **스마트폰 업무전화 이미지** — 직원이 스마트폰으로 업무전화를 확인하는 모습  
   캡션: “개인 휴대폰에서도 회사번호를 업무용으로 활용”

3. **외근 이미지** — 외근 또는 현장 이동 중 통화하는 실제 현장 사진  
   캡션: “사무실 밖에서도 업무전화를 확인할 수 있습니다”

4. **업무/개인 분리 이미지** — 스마트폰과 업무수첩 또는 노트북이 함께 보이는 사진  
   캡션: “방해금지 모드로 업무시간 이후 수신을 조절”

5. **AI 업무지원 이미지** — 통화 후 메모·업무정리 장면  
   캡션: “통화녹음과 AI 요약으로 후속 업무 확인”

6. **상담 마무리 이미지** — 기업통신 장비 또는 사무실 네트워크 현장 사진  
   캡션: “기업의 기존 통신환경을 확인해 맞춤 구성합니다”

### 이미지 공통 표기
- 상단: **유비즈**
- 하단: **1661-7372 · u-biz.co.kr**
- 얼굴, 정확한 주소, 개인 전화번호, 차량번호, IP/MAC/S/N, QR/바코드, 관리자 계정·비밀번호 노출 금지
